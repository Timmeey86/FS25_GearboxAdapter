...
---
---@class EatonFuller18InputStrategy : InputTransformationStrategy
---@field maxEffectiveGear number @The highest possible number this strategy could produce
EatonFuller18InputStrategy = {}
local EatonFuller18InputStrategy_mt = {
	__metatable = setmetatable(EatonFuller18InputStrategy, {__index = InputTransformationStrategy}),
	__index = EatonFuller18InputStrategy
}
...
function EatonFuller18InputStrategy.new()

	local self = setmetatable({}, EatonFuller18InputStrategy_mt)
...
function EatonFuller18InputStrategy:setGearboxInfo(vehicleGearboxInfo)
...
function EatonFuller18InputStrategy:setInputControllerInfo(inputControllerInfo)
	-- Not required for this strategy
end
...
function EatonFuller18InputStrategy:calculateEffectiveGear(shifterInputData)
...
function EatonFuller18InputStrategy:supportsQueueingForGroups()
...
---@return boolean @True if the strategy supports Queueing in general.
function EatonFuller18InputStrategy:supportsQueueingForGears()
	return false
end