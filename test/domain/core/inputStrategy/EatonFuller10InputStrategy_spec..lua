...
describe("Eaton Fuller 10 input strategy", function()
	it("should calculate values as expected", function()
		...
		local inputsAndExpectedOutputs = {
			...
			-- high range
			{ name = "RH (L splitter)", group = 3, slot = 1, expectedDirection = -1, expectedEffectiveGear =  2, expectedGroup = 2, expectedGearInGroup = 1 },
			{ name = "RH (H splitter)", group = 4, slot = 1, expectedDirection = -1, expectedEffectiveGear =  2, expectedGroup = 2, expectedGearInGroup = 1 },
