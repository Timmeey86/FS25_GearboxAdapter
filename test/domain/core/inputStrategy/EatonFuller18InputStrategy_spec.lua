...
describe("Eaton Fuller 18 input strategy", function()
	it("should calculate values as expected", function()
		...
		local inputsAndExpectedOutputs = {
			...
			-- unused (crawler gears irl)
			{ name = "Crawler (LL)", group = 1, slot = 2, expectedDirection =  0, expectedEffectiveGear =  0, expectedGroup = 0, expectedGearInGroup = 0 },
		...
		local strategy = EatonFuller18InputStrategy.new()
