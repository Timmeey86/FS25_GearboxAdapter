...
describe("Volvo 12 input strategy", function()
	it("should calculate values as expected", function()
		...
		local inputsAndExpectedOutputs = {
			...
			-- low range
			{ name = "RLL", group = 1, slot = 2, expectedDirection = -1, expectedEffectiveGear =  1, expectedGroup = 1, expectedGearInGroup = 1 },
			{ name = "RLH", group = 2, slot = 2, expectedDirection = -1, expectedEffectiveGear =  2, expectedGroup = 1, expectedGearInGroup = 2 },
			...
			{ name = "2H",  group = 2, slot = 4, expectedDirection =  1, expectedEffectiveGear =  4, expectedGroup = 2, expectedGearInGroup = 2 },
			{ name = "3L",  group = 1, slot = 5, expectedDirection =  1, expectedEffectiveGear =  5, expectedGroup = 1, expectedGearInGroup = 3 },
			{ name = "3H",  group = 2, slot = 5, expectedDirection =  1, expectedEffectiveGear =  6, expectedGroup = 2, expectedGearInGroup = 3 },
			-- high range
			{ name = "RLH", group = 3, slot = 2, expectedDirection = -1, expectedEffectiveGear =  3, expectedGroup = 1, expectedGearInGroup = 3 },
			{ name = "RHH", group = 4, slot = 2, expectedDirection = -1, expectedEffectiveGear =  4, expectedGroup = 1, expectedGearInGroup = 4 },
			{ name = "4L",  group = 3, slot = 3, expectedDirection =  1, expectedEffectiveGear =  7, expectedGroup = 3, expectedGearInGroup = 1 },
			{ name = "4H",  group = 4, slot = 3, expectedDirection =  1, expectedEffectiveGear =  8, expectedGroup = 4, expectedGearInGroup = 1 },
			{ name = "5L",  group = 3, slot = 4, expectedDirection =  1, expectedEffectiveGear =  9, expectedGroup = 3, expectedGearInGroup = 2 },
			{ name = "5H",  group = 4, slot = 4, expectedDirection =  1, expectedEffectiveGear = 10, expectedGroup = 4, expectedGearInGroup = 2 },
			{ name = "6L",  group = 3, slot = 5, expectedDirection =  1, expectedEffectiveGear = 11, expectedGroup = 3, expectedGearInGroup = 3 },
			{ name = "6H",  group = 4, slot = 5, expectedDirection =  1, expectedEffectiveGear = 12, expectedGroup = 4, expectedGearInGroup = 3 },
			...
			{ name = "C1",        group = 1, slot = 1, expectedDirection =  0, expectedEffectiveGear =  0, expectedGroup = 0, expectedGearInGroup = 0 },
			{ name = "C2",        group = 2, slot = 1, expectedDirection =  0, expectedEffectiveGear =  0, expectedGroup = 0, expectedGearInGroup = 0 },
			{ name = "Slot 6 LL", group = 1, slot = 6, expectedDirection =  0, expectedEffectiveGear =  0, expectedGroup = 0, expectedGearInGroup = 0 },
			{ name = "Slot 6 HH", group = 4, slot = 6, expectedDirection =  0, expectedEffectiveGear =  0, expectedGroup = 0, expectedGearInGroup = 0 },
		...
		local strategy = Volvo12TransformationStrategy.new()
