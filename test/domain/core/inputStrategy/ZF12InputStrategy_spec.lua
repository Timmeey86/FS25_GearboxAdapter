...
describe("ZF 12 input strategy", function()
	it("should calculate values as expected", function()
		...
		local inputsAndExpectedOutputs = {
			...
			{ name = "Slot2 HL",  group = 3, slot = 2, expectedDirection =  0, expectedEffectiveGear =  0, expectedGroup = 0, expectedGearInGroup = 0 },
			{ name = "Slot2 HH",  group = 4, slot = 2, expectedDirection =  0, expectedEffectiveGear =  0, expectedGroup = 0, expectedGearInGroup = 0 },
			...
			{ name = "Slot 4 LL", group = 1, slot = 4, expectedDirection =  0, expectedEffectiveGear =  0, expectedGroup = 0, expectedGearInGroup = 0 },
			{ name = "Slot 4 HH", group = 4, slot = 4, expectedDirection =  0, expectedEffectiveGear =  0, expectedGroup = 0, expectedGearInGroup = 0 },
